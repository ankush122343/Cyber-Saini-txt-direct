...
AUTH_USER = os.environ.get('AUTH_USERS', '6831195071,7180384086').split(',')
...
keyboard = InlineKeyboardMarkup([
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/Query_810bot"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/Query_810bot")],
])

# Image URLs for the random image feature
image_urls = [
    "https://i.ibb.co/HLSP9JJz/Picsart-25-06-05-02-28-20-497.jpg",
    "https://i.ibb.co/HLSP9JJz/Picsart-25-06-05-02-28-20-497.jpg",
...
async def txt_handler(client: Client, m: Message):
    await bot.send_message(m.chat.id, text= (
        ...
        f"➥ @Acebotzz – Admin ji se puch Lijeya na👀\n"
...
@bot.on_message(filters.command(["ace"]) )
async def txt_handler(bot: Client, m: Message):  
